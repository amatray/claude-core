...
- **Calendar policy config** — `~/claude-workflows/claude-core/config/calendar-policy.md` (calendar IDs, scheduling preferences, deep work protection). Create from the template in `config-templates/`.
- **Email voice config** (optional) — `~/claude-workflows/claude-core/config/email-voice.md` for tone/voice templates
- **Goals file** (optional) — `~/claude-workflows/claude-core/config/goals.yaml` for deep work block protection

## First-Time Setup

1. **Config files live in the claude-core repo:**
   Config is version-controlled at `~/claude-workflows/claude-core/config/`. No setup needed.
...
Read these files:
- `~/claude-workflows/claude-core/config/calendar-policy.md` — calendar IDs, scheduling preferences, deep work protection
- `~/claude-workflows/claude-core/config/goals.yaml` — for deep work block protection (if exists)
- `~/claude-workflows/claude-core/config/email-voice.md` — email voice rules (if exists)
...
- **Calendar IDs** -- Add all your Google Calendar IDs to `~/claude-workflows/claude-core/config/calendar-policy.md`. Include personal, work, shared, and any other calendars you want checked for conflicts.
