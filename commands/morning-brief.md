...
- Config files (see First-Time Setup below):
  ...
  - `~/claude-workflows/claude-core/config/calendar-policy.md` -- calendar IDs, working hours, city name
  - `~/claude-workflows/claude-core/config/triage-config.md` -- label IDs, vendor domains, classification rules
  - `~/claude-workflows/claude-core/config/goals.yaml` -- objectives and priorities for goal alignment
...
1. Read `~/claude-workflows/claude-core/config/email-policy.md` -- extract VIP lists (Tier 1, Tier 2), family addresses, @ToSelf label ID
2. Read `~/claude-workflows/claude-core/config/calendar-policy.md` -- extract calendar IDs, working hours, city name, timezone
3. Read `~/claude-workflows/claude-core/config/triage-config.md` -- extract label IDs, vendor domains, classification rules (needed only if triage is enabled)
4. Read `~/claude-workflows/claude-core/config/goals.yaml` -- extract objectives, push_level, active priorities
