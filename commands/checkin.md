...
- Config files (see First-Time Setup below):
  - `~/claude-workflows/claude-core/config/email-policy.md` — VIP lists, email routing rules
  - `~/claude-workflows/claude-core/config/calendar-policy.md` — calendar IDs, working hours
  - `~/claude-workflows/claude-core/config/triage-config.md` — label IDs, classification rules
  - `~/claude-workflows/claude-core/config/goals.yaml` — objectives for goal alignment
...
1. `~/claude-workflows/claude-core/config/email-policy.md` — VIP lists, email routing rules
2. `~/claude-workflows/claude-core/config/calendar-policy.md` — calendar IDs, working hours, timezone
3. `~/claude-workflows/claude-core/config/triage-config.md` — label IDs, classification rules
4. `~/claude-workflows/claude-core/config/goals.yaml` — objectives, push_level, priorities
