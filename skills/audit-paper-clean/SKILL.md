---
name: audit-paper-clean
description: Audit academic papers with clean text corrections throughout (no track-changes markup). Use when you need all suggestions as clean corrected text.
...
- **Module 4**: Deep syntax review (substantial improvements, identify repetition)
- **Module 5**: Polish pass (optional — broader rewrites to improve clarity and flow)
...
4. **Do NOT use track-changes markup** — just provide the clean corrected text
...
When I say **"implement suggestion XX"** (e.g., "implement D3"), you must apply the change by **directly replacing** the original text with the suggested text.
...
For each suggestion, show the original and your proposed rewrite. For substantial rewrites, briefly explain what you changed and why.
...
When I say **"implement suggestion XX"** (e.g., "implement P3"), you must apply the change by **directly replacing** the original text with the suggested text.
